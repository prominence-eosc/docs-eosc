...
.. warning::
   The udocker container runtime must be used for images from Google Container Registry due to `this <https://github.com/sylabs/singularity/issues/1158)>`_ Singularity issue.
